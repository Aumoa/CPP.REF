...
struct CORE_API Quaternion
{
	...
	static Quaternion FromAxisAngle(const Vector3& axis, TDegrees<double> angle);
	...
	static Quaternion FromEuler(TDegrees<double> yaw, TDegrees<double> pitch, TDegrees<double> roll);
