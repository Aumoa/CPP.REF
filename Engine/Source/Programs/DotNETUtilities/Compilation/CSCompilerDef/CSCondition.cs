...
public record CSCondition(string? Configuration, string? Platform)
{
    ...
    public bool Contains(CSCondition condition)
    {
    ...
    public static CSCondition Parse(string content)
    {
        ...
        return new CSCondition(configuration, platform);
    }
}
