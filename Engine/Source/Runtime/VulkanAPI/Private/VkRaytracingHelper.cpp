...
namespace Ayla
{
	...
	void VkRaytracingPipeline::CreatePipeline()
	{
		...
		// Inline SPIR-V shaders (very simple shaders for testing)
		// Ray Generation Shader - outputs red color
		std::vector<uint32_t> raygenCode = {
			// SPIR-V header
			0x07230203, 0x00010000, 0x00080001, 0x00000033,
			...
			0x00000000, 0x00060005, 0x00000009, 0x565f6c67,
			0x65747265, 0x646e4978, 0x00007865, 0x00050048,
			0x00000007, 0x00000000, 0x0000000b, 0x0000001c,
			0x00030047, 0x00000007, 0x00000002, 0x00040047,
			0x00000009, 0x00000022, 0x00000000, 0x00040047,
			0x00000009, 0x00000021, 0x00000000, 0x00020013,
			0x00000002, 0x00030021, 0x00000003, 0x00000002,
			0x00040015, 0x00000006, 0x00000020, 0x00000000,
			0x0004001e, 0x00000007, 0x00000006, 0x00000006,
		...
		// Miss Shader - outputs background color
		std::vector<uint32_t> missCode = raygenCode; // Simple placeholder

		// Closest Hit Shader - outputs green for triangle
		std::vector<uint32_t> chitCode = raygenCode; // Simple placeholder
