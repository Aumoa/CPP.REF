...
namespace libty::inline PlatformGeneric
{
	...
	struct IRHIRootSignature;

	using RHIBoolean = int32;
	...
	struct RHIVertex
	{
		Vector3 Position;
		Vector3 Normal;
		::libty::CoreNumerics::Color Color;
		Vector2 TexCoord;
	};
	...
	{
		RHIBoolean BlendEnable;
		RHIBoolean LogicOpEnable;
		ERHIBlend SrcBlend;
		ERHIBlend DestBlend;
		ERHIBlendOp BlendOp;
	...
	struct RHIBlendDesc
	{
		RHIBoolean AlphaToCoverageEnable;
		RHIBoolean IndependentBlendEnable;
	...
	struct RHIRasterizerDesc
	{
		...
		RHIBoolean FrontCounterClockwise;
		int32 DepthBias;
		float DepthBiasClamp;
		float SlopeScaledDepthBias;
		RHIBoolean DepthClipEnable;
		RHIBoolean MultisampleEnable;
		RHIBoolean AntialiasedLineEnable;
	...
	{
		IRHIRootSignature* pRootSignature;
