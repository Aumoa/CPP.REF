...
{
	SENUM(SLATECORE_API, EFlowDirection, int32,
		LeftToRight,,
		RightToLeft,
	);

	SENUM(SLATECORE_API, EOrientation, int32,
		Horizontal,,
		Vertical,
	);

	SENUM(SLATECORE_API, EWidgetClipping, int32,
		Inherit,,
		ClipToBounds,
	);

	SENUM(SLATECORE_API, EHorizontalAlignment, int32,
		Fill,,
		Left,,
		Center,,
		Right,
	...
	SENUM(SLATECORE_API, EVerticalAlignment, int32,
		Fill,,
		Top,,
		Center,,
		Bottom,
	...
	SENUM(SLATECORE_API, ESizeRule, int32,
		Auto,,
		Stretch,
	);

	SENUM_BEGIN(SLATECORE_API, ESlateVisibility, int32,
		Visible, ,
		Collapsed, ,
		Hidden, ,
		HitTestInvisible, ,
