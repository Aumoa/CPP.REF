...
ND3D12SwapChain::ND3D12SwapChain(IDXGIFactory7* InFactory, ID3D12CommandQueue* InQueue, HWND hWnd)
{
	RECT ClientRect;
...
ND3D12SwapChain::~ND3D12SwapChain() noexcept
{
}

void ND3D12SwapChain::Present()
{
	HR(SwapChain4->Present(1, 0));
}

Vector2N ND3D12SwapChain::GetViewportSize() const
{
	return VpSize;
}

void ND3D12SwapChain::Resize(const Vector2N& InSize)
{
...
void ND3D12SwapChain::AllocateBuffersAndCreateDescriptors()
{
