...
public:
	...
	ArrangedWidget MakeChild(const std::shared_ptr<SWidget>& ChildWidget, const Vector2& LocalSize, const SlateLayoutTransform& LayoutTransform) const;
	ArrangedWidget MakeChild(const std::shared_ptr<SWidget>& ChildWidget, const LayoutGeometry& LayoutGeometry) const;
	ArrangedWidget MakeChild(const std::shared_ptr<SWidget>& ChildWidget, const Translate2D& ChildOffset, const Vector2& LocalSize, const Scale2D& ChildScale = Scale2D::Identity()) const;
