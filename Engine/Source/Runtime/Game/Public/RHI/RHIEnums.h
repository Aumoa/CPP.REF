...
SENUM()
enum class ERHIVertexElementFormat
{
    Unknown = 0,
    R32G32B32A32_FLOAT = 2,
    R32G32B32A32_UINT = 3,
...
SENUM()
enum class ERHIRootParameterType
{
    DescriptorTable = 0,
    _32BitConstants,
    ConstantBuffer,
...
SENUM()
enum class ERHIShaderVisibility
{
    All = 0,
    Vertex,
    Hull,
...
SENUM()
enum class ERHITextureAddressMode
{
    Wrap = 1,
    Mirror = 2,
    Clamp = 3,
...
SENUM()
enum class ERHIStaticBorderColor
{
    TransparentBlack = 0,
...
SENUM()
enum class ERHIConservativeRasterizationMode
{
    Off = 0,
    On = 1
};
...
SENUM()
enum class ERHIPipelineStateFlags
{
    None = 0,
    ToolDebug = 1
};
...
SENUM()
enum class ERHIColorWriteEnable
{
    Red = 1,
    Green = 2,
    Blue = 4,
...
SENUM()
enum class ERHIResourceBarrierType
{
    Transition = 0,
...
SENUM()
enum class ERHIResourceBarrierFlags
{
    None = 0,
    BeginOnly = 0x1,
    EndOnly = 0x2
...
SENUM()
enum class ERHICPUPageProperty
{
    Unknown = 0,
    NotAvailable = 1,
    WriteCombine = 2,
