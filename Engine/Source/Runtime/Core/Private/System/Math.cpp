...
#undef EASE_CASE
	...
	static inline float Floor(float value) noexcept { return std::floor(value); }
	static inline double Floor(double value) noexcept { return std::floor(value); }
	static inline float Ceil(float value) noexcept { return std::ceil(value); }
	static inline double Ceil(double value) noexcept { return std::ceil(value); }
};