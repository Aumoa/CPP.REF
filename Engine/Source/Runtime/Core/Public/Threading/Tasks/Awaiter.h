...
namespace Ayla
{
	...
	public:
		Awaiter(CancellationToken sToken = {}, TaskStatus InitialStatus = TaskStatus::Running)
		...
		virtual TaskStatus GetStatus() const noexcept override
		{
			return Status;
		}
		...
		{
			TaskStatus LocalStatus = GetStatus();
			return LocalStatus == TaskStatus::RanToCompletion
				|| LocalStatus == TaskStatus::Faulted
				|| LocalStatus == TaskStatus::Canceled;
		}
