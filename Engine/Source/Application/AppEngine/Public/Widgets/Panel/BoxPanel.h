...
class APPENGINE_API SBoxPanel : public SPanelWidget
{
...
public:
	...
	inline EOrientation GetOrientation() { return Orientation; }
...
private:
	...
	static constexpr Margin LayoutPaddingWithFlow(const Margin& Padding, EFlowDirection InLayoutFlow)
	{
